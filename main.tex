...
\chapter{関連研究}
\label{chap:realatedwork}
% \input{./section/2_relatedwork.tex}

\chapter{研究と事業の背景}
\label{chap:background}
% \input{./section/3_background.tex}

\chapter{研究の目的}
\label{chap:purpose}
% \input{./section/4_purpose.tex}

\chapter{提案手法}
\label{chap:method}
% \input{./section/5_method.tex}

\chapter{実験}
\label{chap:experiment}
% \input{./section/6_experiment.tex}

\chapter{考察}
\label{chap:consideration}
% \input{./section/7_consideration.tex}

\chapter{今後の展望}
\label{chap:future}
% \input{./section/8_future.tex}
...
また、貴重な御意見、御討論を頂きました北海道大学大学院情報科学研究科メディアネットワーク専攻、青木直史助教に心より感謝いたします。

本研究の実装および実験にご協力いただきましたSt.Arkid株式会社の皆様に深く感謝いたします。
